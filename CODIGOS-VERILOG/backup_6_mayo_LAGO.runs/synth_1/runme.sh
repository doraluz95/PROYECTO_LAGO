...
HD_PWD='C:/Users/Doraluz/project_FINAL/project_FINAL.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log PROYECTO_TOP.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source PROYECTO_TOP.tcl
