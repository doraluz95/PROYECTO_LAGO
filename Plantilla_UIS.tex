...
\include{Secs/T2}   % Marco teórico
\input{Secs/T3}   % sistema de adquisición proyecto LAGO
\input{Secs/T4}   % implementación proyecto LAGO
\input{Secs/T5}   % Resultados
%\input{Secs/T6}   % Recomendaciones
\input{Secs/T7}   % Trabajo futuro
\input{Secs/T8}   % Conclusiones
% ------------------------------------------------------------------------
% Bibliografía
% ------------------------------------------------------------------------
